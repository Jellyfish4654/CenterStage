...
public class BlueContourPipeline extends OpenCvPipeline {
    ...
    public static Scalar lowerBoundYCrCb = new Scalar(0.0, 80.0, 120.0); // Increase the lower Cr bound for red
    public static Scalar upperBoundYCrCb = new Scalar(255.0, 135.0, 180.0); // Decrease the upper Cb bound to exclude blues
